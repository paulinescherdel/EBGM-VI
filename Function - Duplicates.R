...
nettoyage_doublon <- function (entree, mesure, indz,  z, valeur) {
  ...
  # Creation des indicateurs
    tab3<-as.data.frame(subset(tab2, indicateur_final_2m==0))  # Enlever les lignes pour lesquelles indicateur_final_2m=1
  ...
  # Créer la variable comptage qui va s'incrémenter
  ...
  # Rassembler toutes les lignes et mise en forme 
  # ---------------------------------------------
